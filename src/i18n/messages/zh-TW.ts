...
export const zhTW = {
  ...
  "agents.workspace.body": "保存多個 CLI 的啟動類型、參數與工作目錄。下次開啟 LatticeTerm 時，由你確認後重新啟動新的程序。",
  ...
  "agents.workspace.securityTitle": "只保存非機密啟動資料",
  "agents.workspace.securityBody": "最多保存 {count} 個啟動項目；不保存提示、終端輸出、程序 ID、Reporter 權杖或模型憑證。密碼、Token、API Key、Passphrase 與 Secret 參數會被拒絕。",
  ...
  "agents.workspace.confirmBody": "這會立即重新啟動 {count} 個新的本機 CLI 程序。原本的終端內容與程序不會被還原。",
