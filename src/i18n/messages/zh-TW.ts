...
export const zhTW = {
  ...
  "theme.sand": "暖砂",
  "theme.contrast": "高對比",
  "theme.system.hint": "跟著作業系統在深色與淺色之間切換",
  "theme.dark.hint": "預設的薄荷綠深色配色",
  "theme.light.hint": "明亮環境適用",
  "theme.midnight.hint": "偏藍的深色調",
  "theme.graphite.hint": "中性灰的深色調",
  "theme.sand.hint": "低藍光的暖色調",
  "theme.contrast.hint": "加強對比，弱視或強光環境適用",
