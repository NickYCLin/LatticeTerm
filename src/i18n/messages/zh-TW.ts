...
export const zhTW = {
  ...
  "agents.launch": "啟動",
  "agents.resume.eyebrow": "原生 Session 續接",
  "agents.resume.title": "回到 CLI 原本的工作脈絡",
  "agents.resume.body": "目前支援 Codex、Claude Code、Gemini CLI 與 Hermes Agent。LatticeTerm 依各工具官方格式傳入 Session ID 或標題，再把 CLI 開在新的本機終端中。",
  "agents.resume.securityTitle": "續接與保存分開由你決定",
  ...
  "agents.resume.note": "備註（選填）",
  "agents.resume.note.placeholder": "例如：處理 payments 專案的重構",
  "agents.resume.note.hint": "只是給你自己看的說明，保存後會顯示在清單上，一眼就知道這個 CLI 之前在做什麼；最多 200 個位元組。",
  "agents.resume.save": "保存續接項目",
  "agents.resume.launch": "續接 Session",
  "agents.resume.resuming": "續接中…",
  "agents.resume.savedTitle": "續接項目已保存",
  "agents.resume.savedBody": "「{name}」下次可由這份工作區再次續接；識別值不會顯示在清單中。",
  "agents.custom.eyebrow": "自訂 Adapter",
  "agents.custom.title": "接入其他 LLM CLI",
  "agents.custom.body": "輸入可執行檔與明確的參數陣列；系統不會把內容拼成 shell 指令。",
  "agents.custom.label": "顯示名稱",
  "agents.custom.label.placeholder": "例如 My Team Agent",
  "agents.custom.executable": "可執行檔",
  "agents.custom.executable.placeholder": "例如 my-agent 或完整路徑",
  "agents.custom.arguments": "啟動參數",
  "agents.custom.arguments.placeholder": "--model\nteam-model\n--resume",
  "agents.custom.arguments.hint": "每行一個參數；空白行會忽略，最多 64 個。",
  "agents.custom.launch": "啟動自訂 CLI",
  ...
  "agents.workspace.body": "保存多個 CLI 的啟動類型、參數與工作目錄；你明確保存的原生 Session 識別值也能一起還原。下次開啟時仍由你確認才啟動。",
  ...
  "agents.workspace.securityBody": "最多保存 {count} 個啟動項目；原生 Session ID 或標題只在你按下保存時寫入。不保存提示、終端輸出、程序 ID、Reporter 權杖或模型憑證，機密參數仍會被拒絕。",
  ...
  "agents.workspace.empty": "尚未保存啟動項目。可從上方的內建或自訂 CLI 加入。",
