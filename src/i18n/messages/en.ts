...
export const en: Messages = {
  ...
  "settings.notificationsHint": "Mark completed work in the sidebar and play the short cue you choose.",
  "settings.notifications.agentSound": "Agent completion sound",
  ...
  "agents.skills.body": "Automatically discovers available Skills for the working directory and account profile. It reads only names, sources, and descriptions, never Skill instructions or sign-in data.",
  ...
  "agents.skills.empty": "This account profile and project have no recognizable Skills yet.",
  ...
  "agents.account.dialogBody": "Only needed to use two or more {name} accounts side by side (a personal and a work one, say). Signing in does not happen here but in the terminal after launch.",
  "agents.account.profileName": "Account name",
  "agents.account.profileNamePlaceholder": "For example, Work account",
  "agents.account.profileDirectory": "CLI configuration directory",
  ...
  "agents.account.advancedDirectory": "Advanced: reuse a configuration directory that is already signed in",
  "agents.account.existingDirectoryHint": "If you already signed in somewhere else with CLAUDE_CONFIG_DIR or CODEX_HOME, point at that directory; otherwise LatticeTerm creates a new one.",
  "agents.account.saveProfile": "Add",
  "agents.account.profileHint": "Each account's login stays in a directory of its own kept by the assistant; LatticeTerm stores only the name and never touches passwords or tokens.",
  ...
  "agents.account.removeConfirmExternal": "Remove “{name}”? It only leaves the list; the configuration directory you chose and its login stay in place.",
  "agents.account.removeConfirm": "Remove “{name}”? The login data LatticeTerm created for it is deleted too, so it must be signed in again later.",
  "agents.account.removeProfile": "Remove this account",
  "agents.account.step3": "Sign in once in the terminal that opens, following the assistant's prompts. From then on the account is ready whenever you pick it, and its state shows in the list.",
  "agents.account.step2": "Back on the card, pick it under “Account to launch with” and press Launch.",
  "agents.account.step1": "Give it a name and press Add.",
