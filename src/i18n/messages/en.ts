...
export const en: Messages = {
  ...
  "nav.chat": "Chat",
  "nav.chat.desc": "Talk to a local LLM CLI in a chat window instead of a terminal",
  "nav.tunnels": "Tunnels",
  ...
  "chat.empty.body":
    "Pick an installed CLI and a working directory, then type as you would in any chat. The CLI keeps its own login, model access and permissions.",
  "chat.none.title": "No CLI available",
  "chat.none.body":
  ...
  "chat.delete.confirm.body":
    "Only the copy kept here is removed; the CLI's own transcript is untouched.",
  "chat.delete.confirm.action": "Delete",
  "chat.notInstalled": "{cli} is not installed. Install it in AI Agent Fleet first.",
  "chat.session": "CLI conversation id: {id}",
  "chat.storage.note":
