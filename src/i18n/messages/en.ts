...
export const en: Messages = {
  ...
  "tunnels.flow.remoteBind": "SSH Server Bind",
  ...
  "tunnels.flow.localTarget": "LatticeTerm Local Target",
  ...
  "tunnels.form.remoteBindHost": "SSH Server Bind IP",
  "tunnels.form.remoteBindPort": "SSH Server Port",
  "tunnels.form.remoteHost": "Remote Target Host / IP",
  "tunnels.form.remotePort": "Remote Target Port",
  "tunnels.form.localTargetHost": "LatticeTerm Local Target Host / IP",
  "tunnels.form.localTargetPort": "LatticeTerm Local Target Port",
  ...
  "tunnels.sshRequired": "Create an SSH connection profile, verify its host fingerprint, and save its password before starting a tunnel.",
  "tunnels.runtimeError": "Tunnel runtime failed:",
  ...
  "tunnels.error.invalidBindIp": "The bind address must be an IPv4 or IPv6 address.",
  "tunnels.error.dynamicLoopback": "A no-authentication SOCKS5 proxy can only bind to 127.0.0.0/8 or ::1.",
