...
export const en: Messages = {
  ...
  "remote.host.fixedCodeHint": "Paste a previously generated 32-character hexadecimal token, or leave empty for a fresh random token. Do not invent a simple code.",
