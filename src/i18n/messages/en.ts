...
export const en: Messages = {
  ...
  "agents.account.profile": "Launch account profile",
  "agents.account.default": "Default CLI account",
  "agents.account.addProfile": "Add account profile",
  "agents.account.dialogTitle": "Add {name} account profile",
  "agents.account.dialogBody": "Add this account's isolated CLI configuration directory to Fleet; sign in inside that CLI the first time it launches.",
  "agents.account.profileName": "Account name",
  "agents.account.profileNamePlaceholder": "For example, Account A",
  ...
  "agents.account.profileHint": "Use a different directory per account. Only the name and configuration directory are saved; each CLI keeps its own sign-in data.",
  ...
  "chat.accountProfile.default": "Default CLI account",
  "chat.accountProfile.handoff": "Switching accounts starts a new native conversation and safely carries recent context.",
  "chat.accountProfile.hint": "Manage account profiles in AI Agent Fleet; the CLI exclusively owns sign-in state and credentials. Codex and Claude Code support isolated profiles.",
