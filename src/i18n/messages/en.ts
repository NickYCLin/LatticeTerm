...
export const en: Messages = {
  ...
  "form.remoteDirect.body": "This version still needs the sharing device's IP or hostname and port. The pairing code authenticates the connection; it is not a network-resolvable device ID. Numeric device IDs can replace these fields after signaling, relay and NAT traversal services are available.",
  ...
  "agents.geminiMigration.title":
    "Personal Google accounts must use Antigravity CLI",
  "agents.geminiMigration.toggle": "Show or hide account notice details",
  "agents.geminiMigration.body":
    "Google ended consumer OAuth service for Gemini CLI on June 18, 2026, including Google AI Pro and Ultra. Personal subscribers should install and launch Google Antigravity CLI. Gemini Code Assist Standard/Enterprise, API-key, and Vertex AI authentication are unaffected.",
