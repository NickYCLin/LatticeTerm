...
export const en: Messages = {
  ...
  "terminal.projects.statusGuideWorking": "Blue: Working",
  "terminal.projects.statusGuideAttention": "Yellow: Needs attention",
  "terminal.projects.statusGuideIdle": "Gray: Idle",
  "terminal.projects.statusGuideDone": "Green: Done",
  ...
  "chat.accountProfile.add": "Add profile",
  "chat.accountProfile.namePrompt": "Profile name, for example Personal, Work, or Project",
  "chat.accountProfile.chooseDirectory": "Choose this account's CLI configuration directory",
  "chat.accountProfile.handoff": "Switching accounts starts a new native conversation and safely carries recent context.",
  "chat.accountProfile.hint": "Only the name and selected local configuration directory are saved; the CLI exclusively owns sign-in state and credentials. Codex and Claude Code support isolated profiles.",
  "chat.accountProfile.failed": "Could not add account profile: {detail}",
