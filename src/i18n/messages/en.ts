...
export const en: Messages = {
  ...
  "agents.account.dialogBody": "Just give it a name. LatticeTerm creates a configuration directory of its own for this account; sign in as usual the first time the CLI starts and the login stays in that account's directory.",
